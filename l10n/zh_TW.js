OC.L10N.register(
    ...
    "Group settings" : "群組設定",
    "If a user is part of multiple groups, the union of the groups configurations will be applied." : "若使用者屬於多個群組，將會套用群組設定的聯集。",
    "Load more…" : "載入更多……",
    "Loading…" : "正在載入……",
    "No results" : "無結果",
    "Saved" : "已儲存",
    "Search" : "搜尋",
    "Search Page" : "搜尋頁面",
    "Security is applied by the search providers." : "安全措施是由搜尋提供者提供的。",
    "See all providers" : "檢視所有提供者",
    "See only results for this provider" : "僅檢視該提供者的結果",
    "Select the providers that will be available to all the users:" : "選取所有使用者可用的提供者：",
    "Select the providers that will be available to the users in group \"{group}\":" : "選擇群組「{group}」中的使用者可以使用的提供者：",
    "Show only" : "僅顯示",
