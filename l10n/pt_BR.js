OC.L10N.register(
    ...
    "Enable inline search modal" : "Ativar o modal de pesquisa embutido",
    ...
    "Nextcloud 34 started hiding installed application in a menu, making it harder to reach The Search Page. This experimental feature hi-jacks the unified search of Nextcloud." : "A partir da versão 34, o Nextcloud passou a ocultar os aplicativos instalados em um menu, dificultando o acesso ao The Search Page. Esse recurso experimental substitui a pesquisa unificada do Nextcloud.",
    "No applications found." : "Nenhum aplicativo encontrado.",
    "No results" : "Sem resultados",
    "Not all providers support date filters." : "Nem todos os provedores oferecem suporte a filtros de data.",
    "Not available to any group" : "Não disponível para nenhum grupo",
    "Note:" : "Nota:",
    "Note: not all search providers support date filters." : "Observação: nem todos os provedores de pesquisa oferecem suporte a filtros de data.",
    ...
    "Settings pages" : "Página de configurações",
